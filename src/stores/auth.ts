...
export const useAuthStore = defineStore('auth', () => {
   ...
   * Used in production (*.hafizmuh.site)
   */
   ...
   * Production: Stores in cookie with Domain=.hafizmuh.site
   ...
   *
   * @param requiredRole Role to check (e.g., 'CUSTOMER', 'ACCOMMODATION_OWNER')
